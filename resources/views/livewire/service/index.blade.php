                        ...
                        <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $service->name }}</td>
                                    <td>
                                        <a class="btn btn-warning btn-sm text-white" href="#" wire:click.prevent="editService({{ $service->id }})" data-bs-toggle="modal" data-bs-target="#edit"><i class="fa-regular fa-pen-to-square"></i></a>
                                        <a class="btn btn-danger btn-sm" href="#" wire:click.prevent="deleteService({{ $service->id }})"><i class="fa-regular fa-trash-can"></i></a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
